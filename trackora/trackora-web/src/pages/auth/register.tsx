    ...
    <div className="flex min-h-screen bg-background">
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              'radial-gradient(circle, hsl(234 85% 60% / 0.3) 0%, transparent 70%)',
            filter: 'blur(40px)',
          }}
        />
        <div
          ...
          style={{
            background:
              'radial-gradient(circle, hsl(280 80% 60% / 0.25) 0%, transparent 70%)',
            filter: 'blur(40px)',
        ...
        <div className="relative z-10 animate-fade-in-up">
          ...
          <p className="mt-3 max-w-md text-sm leading-relaxed text-slate-400">
            Join thousands of teams that use Trackora to ship faster with
            confidence.
          </p>
        </div>
        ...
        <div className="stagger-children relative z-10 space-y-3">
          {features.map((f) => (
            ...
            >
              <div
                className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br ${f.color} border border-white/10 transition-transform duration-300 group-hover:scale-110`}
              >
                <f.icon className={`h-5 w-5 ${f.iconColor}`} />
              </div>
              <div className="flex-1">
                <p className="font-semibold leading-tight text-white/90">
                  {f.title}
                </p>
